// Import images
import Image1 from '../images/epp1.jpg';
	...
	ProjectInfo: {
		...
		CompanyInfo: [
			...
			},
			{
				id: 3,
				title: 'Website',
				details: 'https://excellerentsolutions.com',
			},
			{
				id: 4,
				title: 'Address',
				details: 'Kebede Haile Building, Bole Road, Addis Ababa, Ethiopia',
			},
		],
		ObjectivesHeading: 'About Excellerent',
		ObjectivesDetails:
			'Excellerent is a global consulting company offering end-to-end services and solutions on Open Source, Cloud, API, and Automation technologies.',
		Technologies: [
			{
